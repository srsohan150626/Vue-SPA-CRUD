        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
              <div class="breadcrumb float-sm-right">
                    <router-link to="/add-products" class="btn btn-primary"> Add Products</router-link>
              </div>
              ...
              <div class="card-body">
                ...
                <table class="table table-bordered table-striped">
                  ...
                  <tr v-for="product in filtersearch" :key="product.id">
                    <td>{{ product.id }}</td>
                    <td>{{ product.title }}</td>
                    <td><img :src="product.image" alt="" id="pro_img"></td>
                    <td>{{ product.price }}</td>
                    <td> {{ product.description | striphtml }}</td>
                    <td>
                       <router-link :to="{name: 'edit-product', params:{id: product.id}}" class="btn btn-warning">Edit</router-link>
